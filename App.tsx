        ...
        return (
          <div className="animate-fade-in flex flex-col items-center">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full max-w-7xl pb-20">
              {[
                { t: ToolType.PALETTE_GENERATOR, title: t[ToolType.PALETTE_GENERATOR], desc: t.paletteToolDesc, Icon: PaletteIcon, bgClass: 'from-[#F59E0B] to-[#EA580C]', iconContainer: 'bg-white/20 text-white', descColor: 'text-amber-100' },
                { t: ToolType.DIELINE_GENERATOR, title: t[ToolType.DIELINE_GENERATOR], desc: t.dieDesc, Icon: DielineIcon, bgClass: 'from-[#3B82F6] to-[#2563EB]', iconContainer: 'bg-white/20 text-white', descColor: 'text-blue-100' },
                { t: ToolType.PATTERN_GENERATOR, title: t[ToolType.PATTERN_GENERATOR], desc: t.patternDesc, Icon: PatternIcon, bgClass: 'from-[#6366F1] to-[#4338CA]', iconContainer: 'bg-white/20 text-white', descColor: 'text-indigo-100' },
                { t: ToolType.PRINT_SIZES, title: t[ToolType.PRINT_SIZES], desc: t.printDesc, Icon: PrintIcon, bgClass: 'from-[#10B981] to-[#047857]', iconContainer: 'bg-white/20 text-white', descColor: 'text-emerald-100' },
                { t: ToolType.SOCIAL_SIZES, title: t[ToolType.SOCIAL_SIZES], desc: t.socialDesc, Icon: SocialIcon, bgClass: 'from-[#E11D48] to-[#9F1239]', iconContainer: 'bg-white/20 text-white', descColor: 'text-rose-100' },
                { t: ToolType.GRID_GENERATOR, title: t[ToolType.GRID_GENERATOR], desc: t.gridDesc, Icon: GridIcon, bgClass: 'from-[#3B82F6] to-[#1D4ED8]', iconContainer: 'bg-white/20 text-white', descColor: 'text-blue-100' },
                { t: ToolType.CALENDAR_CONVERTER, title: t[ToolType.CALENDAR_CONVERTER], desc: t.calDesc, Icon: DateIcon, bgClass: 'from-[#10B981] to-[#047857]', iconContainer: 'bg-white/20 text-white', descColor: 'text-emerald-100' },
                { t: ToolType.SVG_LIBRARY, title: t[ToolType.SVG_LIBRARY], desc: t.svgDesc, Icon: ShapesIcon, bgClass: 'from-[#06B6D4] to-[#0891B2]', iconContainer: 'bg-white/20 text-white', descColor: 'text-cyan-100' },
                { t: ToolType.QR_GENERATOR, title: t[ToolType.QR_GENERATOR], desc: t.qrDesc, Icon: QrIcon, bgClass: 'from-[#EC4899] to-[#DB2777]', iconContainer: 'bg-white/20 text-white', descColor: 'text-pink-100' },
                { t: ToolType.BARCODE_GENERATOR, title: t[ToolType.BARCODE_GENERATOR], desc: t.barcodeDesc, Icon: BarcodeIcon, bgClass: 'from-slate-700 to-slate-900', iconContainer: 'bg-white/20 text-white', descColor: 'text-slate-100' },
                { t: ToolType.PDF_TOOLS, title: t[ToolType.PDF_TOOLS], desc: t.pdfDesc, Icon: PdfIcon, bgClass: 'from-[#DC2626] to-[#991B1B]', iconContainer: 'bg-white/20 text-white', descColor: 'text-red-100' },
                { t: ToolType.IMAGE_COMPRESSOR, title: t[ToolType.IMAGE_COMPRESSOR], desc: t.compressDesc, Icon: CompressIcon, bgClass: 'from-[#DB2777] to-[#9D174D]', iconContainer: 'bg-white/20 text-white', descColor: 'text-pink-100' },
                { t: ToolType.UNIT_CONVERTER, title: t[ToolType.UNIT_CONVERTER], desc: t.appDesc, Icon: UnitIcon, bgClass: 'from-[#0D9488] to-[#0F766E]', iconContainer: 'bg-white/20 text-white', descColor: 'text-teal-100' },
                { t: ToolType.NUTRITION_LABEL, title: t[ToolType.NUTRITION_LABEL], desc: t.appDesc, Icon: NutritionIcon, bgClass: 'from-[#EA580C] to-[#C2410C]', iconContainer: 'bg-white/20 text-white', descColor: 'text-orange-100' },
                { t: ToolType.VAT_CALCULATOR, title: t[ToolType.VAT_CALCULATOR], desc: t.vatDesc, Icon: CalculatorIcon, bgClass: 'from-[#16A34A] to-[#15803D]', iconContainer: 'bg-white/20 text-white', descColor: 'text-green-100' },
                { t: ToolType.BMR_CALCULATOR, title: t[ToolType.BMR_CALCULATOR], desc: t.bmrDesc, Icon: FireIcon, bgClass: 'from-[#EAB308] to-[#CA8A04]', iconContainer: 'bg-white/20 text-white', descColor: 'text-yellow-100' },
                { t: ToolType.PANTONE_MATCH, title: t[ToolType.PANTONE_MATCH], desc: t.pantoneDesc, Icon: SwatchIcon, bgClass: 'from-[#06B6D4] to-[#3B82F6]', iconContainer: 'bg-white/20 text-white', descColor: 'text-cyan-100' },
              ].map((item) => (
                <button
                  key={item.t}
