...
export const ShapesIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2l10 6.5V15.5L12 22l-10-6.5V8.5L12 2z" />
  </svg>
);
...
export const NutritionIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2l3 6 6 1-4.5 4.5 1 6.5-5.5-3-5.5 3 1-6.5L2 9l6-1 3-6z" />
  </svg>
);
...
export const FireIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M8.08 15.82L12 21l3.92-5.18a7.5 7.5 0 1 0-7.84 0z" />
  </svg>
);
...
export const EyeDropperIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M11 4l7 7m-1.5 1.5l-7 7-4 1 1-4 7-7z" />
    <path d="M11 4c1-1 2-1 3 0l3 3c1 1 1 2 0 3" />
  </svg>
);
...
// Pattern: Repeated geometric shapes
