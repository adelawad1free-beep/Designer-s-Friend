...
export const PaletteIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10c1.1 0 2-.9 2-2 0-.49-.18-.95-.51-1.3-.3-.35-.49-.81-.49-1.33 0-1.1.9-2 2-2h1.9c3.31 0 6-2.69 6-6 0-4.97-4.48-9-10-9z" />
  </svg>
);
...
export const BarcodeIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M3 5v14M21 5v14M7 5v14M11 5v14M14 5v14M17 5v14" />
  </svg>
);
...
export const SwapIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <polyline points="16 3 21 3 21 9" />
    <line x1="4" y1="20" x2="21" y2="3" />
    <polyline points="8 21 3 21 3 15" />
...
export const EyeDropperIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M11 20l-5-5M15 16l-5-5M19 12l-5-5M22 2l-3 3M5 22l-3-3" />
  </svg>
);
